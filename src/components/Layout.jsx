...
/**
 * Persistent app shell rendered around every authenticated route.
 *
 * Sidebar lives on the left (desktop) and bottom (mobile); the active route
 * renders into the `<Outlet />`. Auth and BrowserRouter live one level up in
 * <App />.
 */
