  ...
  if (loading) {
    return (
      <div className="w-full flex items-center gap-2 bg-slate-800/40 border border-dashed border-purple-500/20 rounded-lg px-3 py-2.5">
        ...
        <span className="text-[10px] font-semibold text-slate-500 uppercase tracking-wider shrink-0">Sentiment</span>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          {ev.cognitive_bonus != null && ev.cognitive_bonus !== 0 && (
            <span className={`text-[10px] font-mono font-bold ${ev.cognitive_bonus > 0 ? 'text-emerald-400' : 'text-rose-400'}`}>
